...
export const news: NewsItem[] = [
  { date: '2026-08-20', display: 'Aug 2026', title: 'Speaker at the Claude Science AMA', venue: "Anthropic · live demo and open Q&A on accelerating scientific discovery, alongside Alexander Tarashansky, PhD, who leads engineering on Claude Science · I showed how the workbench actually sits in my day-to-day cancer epigenomics research, and talked through NCypher, the tool I built at their Life Sciences hackathon", tag: 'Talk', img: '/assets/news/claude-science-ama.png', featured: true, links: [{ href: 'https://www.anthropic.com/webinars/claude-science-ama-how-to-accelerate-scientific-discovery', label: 'Recording' }] },
  { date: '2026-07-24', display: 'Jul 2026', title: 'A week of robot-assisted endomicroscopy at Imperial', venue: 'Imperial College London Robotics Summer School, 20 to 24 July 2026 · Hamlyn Centre for Robotic Surgery · our team built the pipeline end to end, from data cleaning and augmentation through model training to analysis, to keep a probe-based confocal laser endomicroscopy (pCLE) probe automatically in focus on living tissue, so a surgeon can read cells right at the margin of a tumour in real time · my part was the interpretability: HiResCAM to work out what the model truly relies on when it judges distance from focus, then causal and sanity checks until I trusted the answer · supervised by Dr Stamatia Giannarou', tag: 'Programme', img: '/assets/news/imperial-summer-school.jpg', links: [{ href: 'https://www.imperial.ac.uk/robotics/imperial-robotics-summer-school/programme/', label: 'Programme' }] },
  { date: '2026-07-17', display: 'Jul 2026', title: 'First place, Built with Claude: Life Sciences · NCypher', venue: 'Researcher track winner · Anthropic × Cerebral Valley, with Gladstone Institutes · 1 of 299 projects · an honest MCP triage tool for non-coding cancer variants: a regulatory-activity score, the mechanism a variant breaks, and a confidence flag', tag: 'Award', img: '/assets/news/ncypher-winner.png', links: [{ href: 'https://cerebralvalley.ai/e/built-with-claude-life-sciences', label: 'Event' }, { href: 'https://github.com/faith-ogun/ncypher', label: 'Repo' }, { href: 'https://www.youtube.com/watch?v=0EQfVwYXFG8', label: 'Demo' }] },
  ...
  { date: '2026-07-15', display: 'Jul 2026', title: 'Onkydra opens its waitlist', venue: 'The in-silico stratification workspace for rare-cancer drug development · drop in a target, it simulates the cohort, predicts the responder subgroup with confidence intervals, ranks resistance pathways and cites every claim · beachhead H3 K27M diffuse midline glioma · a Gemini XPRIZE 2026 entry · research use only', tag: 'Launch', img: '/assets/news/onkydra-launch.png', links: [{ href: 'https://onkydra.com', label: 'Onkydra.com' }] },
