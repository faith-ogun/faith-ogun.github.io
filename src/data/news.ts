...
export const news: NewsItem[] = [
  { date: '2026-07-09', display: 'Jul 2026', title: 'Accepted to Built with Claude: Life Sciences', venue: 'Anthropic × Cerebral Valley, with Gladstone Institutes · 500 selected from 6,000 applications in 72 hours, across 47 countries · working on diffuse midline glioma through an epigenetic lens', tag: 'Selection', img: '/assets/news/built-with-claude.jpeg', featured: true, links: [{ href: 'https://cerebralvalley.ai/e/built-with-claude-life-sciences', label: 'Event' }, { href: 'https://www.linkedin.com/posts/faith-ogundimu_builtwithclaude-lifesciences-computationalbiology-activity-7482371910316625920-RHGg', label: 'LinkedIn' }] },
