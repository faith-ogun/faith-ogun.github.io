...
export const news: NewsItem[] = [
  { date: '2026-07-09', display: 'Jul 2026', title: 'Accepted to Built with Claude: Life Sciences', venue: 'Anthropic × Cerebral Valley, with Gladstone Institutes · 500 selected from 6,000 applications in 72 hours, across 47 countries · working on diffuse midline glioma through an epigenetic lens', tag: 'Selection', img: '/assets/news/built-with-claude.jpeg', featured: true, links: [] },
  { date: '2026-06-30', display: 'Jun 2026', title: 'Attended the Unaite Fellowship for AI in Biology Open House', venue: 'Unaite × Singular · AI × Biology research fellowship · Paris', tag: 'Event', img: '/assets/news/unaite.jpeg', links: [{ href: 'https://luma.com/d027eojb?tk=JLjeKh', label: 'Event' }] },
  { date: '2026-06-29', display: 'Jun 2026', title: 'Attended YC Startup School (Paris)', venue: 'Accepted in under 30 minutes — one of 100 participants from over 4,000 applications', tag: 'Programme', img: '/assets/news/yc.jpeg', links: [{ href: 'https://events.ycombinator.com/yc-paris-sus', label: 'Event' }] },
