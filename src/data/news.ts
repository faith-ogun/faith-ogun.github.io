...
export const news: NewsItem[] = [
  ...
  { date: '2026-07-24', display: 'Jul 2026', title: 'A week of robot-assisted endomicroscopy at Imperial', venue: 'Imperial College London Robotics Summer School, 20 to 24 July 2026 · Hamlyn Centre for Robotic Surgery · keeping a confocal endomicroscopy probe automatically in focus on living tissue, so a surgeon can read cells at a tumour margin in real time · my part was the interpretability, with HiResCAM', tag: 'Programme', img: '/assets/news/imperial-summer-school.jpg', links: [{ href: 'https://www.imperial.ac.uk/robotics/imperial-robotics-summer-school/programme/', label: 'Programme' }] },
